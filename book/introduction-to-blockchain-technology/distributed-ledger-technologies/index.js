...
export default () => (
  <PageLayout>
    <Page>
      ...
      <Paragraph>
        To overcome some of the blockchain problems, in particular the
        difficulty to scale, different project have tried to redesigned the
        underlying structure of the distributed ledger while keeping the core
        concept intact.
      </Paragraph>
      <Important>
      ...
      <Paragraph>
        Tangle is a data structure created by IOTA to power their
        cryptocurrency. In a tangle-base DLT the global blockchain is
        substituted with a tangle.
      </Paragraph>
      <Important>
