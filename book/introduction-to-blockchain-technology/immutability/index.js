  ...
  <PageLayout>
    <Page>
      ...
      <Paragraph>
        ...
        transaction in the past, this change will affect all the following
        blocks, resulting in a different state. Without something like hash
        functions, nodes would not be able to know if the integrity of the
        ledger has been preserved over time.
      </Paragraph>
      <Important>
      ...
      <Paragraph>
        A tamper-evident system is not enough to guarantee immutability. We need
        a system that is tamper-proof, not just tamper-evident. Everyone could
        take the blockchain and modify the transactions, it is not a big deal.
        The problem arise when the attacker try to convince the network that the
