...
import { HighlightableParagraph, Page, ChapterTitle } from 'components';
...
const ThePowerOfInnovation = () => (
  <Page>
    ...
    <HighlightableParagraph>
      ...
      new technology or a new idea could bring. New ideas have the power to
      destroy entire markets in a matter of years, just like Napster destroyed
      Tower Records by simply showing that it was possible to share music files
      between people. Napster was shut down, but once the world understood the
