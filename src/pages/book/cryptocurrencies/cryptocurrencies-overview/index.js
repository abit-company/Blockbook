  ...
  <PageTemplate>
    <Page>
      ...
      <Paragraph>
        ...
        central authority. Cryptocurrencies have properties similar to
        commodities (you own the money) but they can be traded like digital
        currencies.
      </Paragraph>
      ...
      <Paragraph>
        ...
        <Italic>Token</Italic> is used to identify a cryptocurrency that
        represent a particular asset or utility (e.g gain access to some
        service) or that it is built on top of a third party blockchain (e.g
        cryptocurrencies built on top of Ethereum are usually referred as
        token). However a lot of cryptocurrencies could fit in both case
        resulting in a difficult classifications. We are not going to follow a
        strict terms division.
      </Paragraph>
      <SubChapterTitle>Key characteristic</SubChapterTitle>
      <Paragraph>
        A cryptocurrency inherits all the characteristic of its underlying
        Blockchain. Depending on how the blockchain is designed it is possible
        to build cryptocurrencies focused on performance, privacy,
        decentralization or any other characteristic. Most of the
        cryptocurrencies however share a set of common characteristics.
      </Paragraph>
      <ul>
        <li>
          <Bold>Digital.</Bold> All cryptocurrencies exist only in a digital
          form as units of account in a distributed ledger. There is no physical
          equivalent of a cryptocurrency.
        </li>
        <li>
          <Bold>Trustless.</Bold> With digital currencies you don’t have to
          trust a person, a commodity or a central institution in order to make
          transactions. Trust is moved from a central authority to distributed
          consensus (following a cryptoeconomics model).
        </li>
        <li>
          <Bold>Global.</Bold> Cryptocurrencies are not subjected to any
          physical or political boundary. It is enough to have an internet
          connection to make a transaction.
        </li>
        <li>
          <Bold>Secure.</Bold> Ownership of cryptocurrencies can be proved
          exclusively cryptographically. It doesn't matter if you are a human or
          a machine, cryptocurrencies belongs to those who own the private keys.
          A transaction can only be issued if an actor is able prove the
          ownership of the keys.
        </li>
        <li>
          <Bold>Immutable.</Bold> Once a transaction is confirmed and added to
          the blockchain no one can reverse or delete it.
        </li>
        <li>
          <Bold>Consensus-based.</Bold> In a cryptocurrency, the rule set is
          programmed into the Blockchain consensus which governs the
          decentralized network. Consensus is in charge of deciding if a
          transaction is valid or not and defines the monetary policy of a
          cryptocurrency.
        </li>
        <li>
        ...
        <li>
          ...
          censorship-free. You can transfer 1$ equivalent of cryptocurrency or
          100 millions dollars to anyone, the Blockchain does not care.
        </li>
      </ul>
      ...
      <Paragraph>
        Every cryptocurrency has a rate of growth that is defined
        mathematically. It is possible to know how many coins exist right now
        and how many coins will exist in ten years.
      </Paragraph>
      <ul>
        <li>
          <Bold>Total supply:</Bold> total amount of coins which has already
          been generated.
        </li>
        <li>
          <Bold>spendable supply (circulating supply):</Bold> the amount of
          coins in circulation that could potentially be traded. Spendable
          supply is less or equal to the total supply. The main scenarios where
          the spendable supply is inferior to the total supply are:
          <ul>
            <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              coins that will exist (e.g a cryptocurrency that increase the
              total supply of 1% every year). A cryptocurrency could start with
              an uncapped supply and then set a limit in the future.
            </li>
          </ul>
        </li>
      </ul>
      ...
      <Paragraph>
        Cryptocurrencies can be distributed in two ways: via mining or via
        direct sale. Depending on this we could identify four categories:{' '}
        <Italic>minable, non-minable, mintable and pre-mined</Italic>.
        <ul>
          <li>
            In <Bold>Mineable</Bold> cryptocurrencies new coins are created
            every time a miner successfully add a new block to the blockchain.
            Distributing coins through mining enforce a predictable and
            decentralized model while giving economics incentives to the miners
            to behave correctly.
          </li>
          <li>
            In <Bold>Non-mineable </Bold>
            cryptocurrencies all the coins are generated when the blockchain is
            initialized and then sold to people. This is usually the model used
            in ICOs.
          </li>
          <li>
          ...
          <li>
            ...
            percentage of the blockchain is mined before being traded on the
            open market.
          </li>
        </ul>
      </Paragraph>
