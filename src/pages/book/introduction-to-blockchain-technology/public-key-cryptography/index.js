...
const PublicKeyCryptography = () => (
  <Page>
    ...
    <Paragraph>
      Public-key cryptography is a cryptographic system widely used all over the
      internet, which is the foundation of many blockchain concepts. As we will
      see blockchain <Italic>addresses</Italic> are created using this
    ...
    <Important>
      ...
      <ul>
        ...
        <li>
          <Bold>A public key</Bold>, derived from the private key, which can be
          shared to everyone.
        </li>
    ...
    <Paragraph>
      ...
      but reversing this operation (finding the private key from the public key)
      is practically infeasible (with today’s most powerful supercomputer it
      would take millions of years of computations). Public key cryptography can
      be used to guarantee properties like encryption, authentication, integrity
      and non-repudiation, even in a non-secure environment like the Internet.
    </Paragraph>
    ...
    <Paragraph>
      The most immediate use case of public-key cryptography is when we want to
      transfer a message over an insecure channel (like the Internet) yet
    ...
    <Paragraph>
      Hashing is used to validate the integrity of the data. Encryption encodes
      data for the primary purpose of ensuring data confidentiality. Encryption
      requires the private key to to reverse the function and decrypt the
      message, while an hash function can’t be reversed (one-way function)
    </Paragraph>
    <SubChapterTitle>
    ...
    <Paragraph>
      ...
      identity, except that they use math instead of an handwritten signatures.
      Digital signatures are created with a combination of hashing and
    ...
    <ul>
      <li>
        <Paragraph>
          ...
          does not require to know the real identity but it requires to provide
          a piece of information that is connected to your identity (the private
          key).
        </Paragraph>
      </li>
      <li>
