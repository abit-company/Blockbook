...
const IntroductionToBlockchainTechnology = () => (
  <PageTemplate>
    <Page>
      ...
      <Paragraph>
        The concept of Blockchain was introduced in 2008 by Satoshi Nakamoto in
        a paper called{' '}
        <cite>“Bitcoin: A Peer-to-Peer Electronic Cash System”</cite>, and then
        implemented for the first time in 2009 as part of the Bitcoin.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        A Blockchain can be seen as a protocol that guarantees special
        properties to the applications built on top of it. It is not just a
        technological change, it is a complete paradigm shift: from
        centralization to decentralization, from close to open, from trust to
