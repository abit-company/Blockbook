...
const sections = [
  {
    title: 'What is Blockbook',
    text: `It’s an experiment. We want to condense the knowledge of the
  blockchain community to create the definitive, adaptive guide on
  Blockchain technology.`,
  },
  {
    title: 'Free and open source',
    text: `We believe the best way to achieve our goal is by allowing anyone to
  contribute to it. We want it to be free and accessible to everyone.`,
  },
  {
    title: 'About us',
    text: `We are blockchain lovers committed to making the world a more
